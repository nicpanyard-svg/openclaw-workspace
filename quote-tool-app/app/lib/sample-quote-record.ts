...
export const sampleQuoteRecord: QuoteRecord = {
  metadata: {
    ...
    companyKey: "inet",
    outputTemplateKey: "inet_proposal",
  ...
  sections: {
    ...
    sectionB: {
      ...
      allowLineRemove: true,
      allowReorder: true,
      builderLabel: "Router and install materials",
      title: "Router, terminal, and install materials",
      introText: "The prices below reflect one-time connectivity hardware, router, and installation material charges.",
      lineItems: [
        {
          id: "b_gen3_perf",
          sourceType: "standard",
        ...
        },
        {
          ...
          sourceLabel: "Connectivity hardware",
        },
        {
          id: "b_install_materials",
          sourceType: "standard",
    ...
    sectionC: {
      ...
      allowLineRemove: true,
      allowReorder: true,
      builderLabel: "Install and site services",
      title: "Install and site services",
      introText: "Use this section for site inspections, installation allowance, configuration labor, and other simple service rows.",
      lineItems: [
        {
          id: "c_site_ny",
          sourceType: "custom",
