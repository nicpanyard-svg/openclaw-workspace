        ...
        <section className="rounded-[28px] border border-white/60 bg-[var(--workspace-panel)] p-6 shadow-[0_16px_40px_rgba(75,88,106,0.12)] backdrop-blur">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <div className="builder-stat-card"><div className="builder-stat-label">Proposal status</div><div className="builder-stat-value">Ready</div><div className="builder-stat-note">Totals are current and ready to review</div></div>
            </div>
          </div>
            ...
            <section className="builder-panel">
              <div className="builder-panel-header">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <SectionToggle label="Optional Field Services" enabled={quote.sections.sectionC.enabled} onChange={(next) => updateQuote((draft) => { draft.sections.sectionC.enabled = next; return draft; })} />
                </div>
              </div>
                ...
                <div className="mt-5 space-y-3">
                  {activeSectionARows.map((row, index) => (
                    <div key={row.id} className="line-editor-card">
                      ...
                      <div className="mt-3 flex flex-wrap items-center justify-between gap-3 text-[13px] text-[#66717d]"><span>{row.rowType === "support" ? "Included support" : "Monthly service line"}</span><span>{row.rowType === "support" ? "Included row" : `Subtotal: ${formatCurrency(row.totalMonthlyRate ?? row.monthlyRate ?? 0, currencyCode)}`}</span></div>
                    </div>
                  ))}
                </div>
              </section>
          ...
          <aside className="space-y-6">
            <section className="builder-panel sticky top-6">
              ...
              <div className="space-y-5 text-[14px] text-[#32404c]">
                ...
                <div className="summary-block"><div className="summary-label">Current Pricing</div><div className="summary-value">Current quote data</div><div className="summary-subvalue">Recommended defaults plus any edits you made in this quote</div></div>
